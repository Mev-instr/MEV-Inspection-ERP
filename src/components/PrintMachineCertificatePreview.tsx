...
export function PrintMachineCertificatePreview({ certificate, onClose, autoPrint = false }: PrintMachineCertificatePreviewProps) {
  const [template, setTemplate] = useState("template1"); // Use no approval template as default for direct printing
  ...
  const templates = [
    ...
    { id: "template_approved", name: "Template (Approved)" }
  ];
                  ...
                  <div className="flex gap-[3px] px-10 mt-4">
                     ...
                     <div className="flex items-center justify-center border-2 border-slate-200 rounded-xl px-8 py-2 bg-white w-1/3">
                        <div className="flex flex-col text-center w-full">
                           ...
                           <span className={`text-[42px] font-black leading-none uppercase tracking-wider ${certificate.result?.toUpperCase() === "FAIL" ? "text-rose-600" : "text-emerald-600"}`}>
                              {certificate.result?.toUpperCase() === "PASS" ? "PASS" : certificate.result?.toUpperCase() === "FAIL" ? "FAIL" : certificate.result || "PASS"}
                           </span>
                        </div>
                     </div>
                     ...
                     <div className="flex flex-1 border-2 border-[#683EFF]/20 rounded-xl bg-white overflow-hidden divide-x-2 divide-[#683EFF]/20">
                        <div className="flex-1 flex flex-col items-center justify-center py-2 px-1">
                           <div className="w-5 h-5 flex items-center justify-center mb-1.5 text-[#683EFF]">
