...
export function TrainingJobsPortfolioView({ jobs, onJobsChange }: TrainingJobsPortfolioProps) {
  ...
  const handleBulkExport = () => {
    ...
    const headers = [
      "ID", "Course Title", "Instructor", "Target Date", "Registered Candidates",
      "Status", "Location", "Naming Series", "Trainer ID", "Training Start Date",
      "Training End Date", "Client Name", "Attention Location", "Attention Phone",
    ...
    const rows = jobs
      ...
      .map(j => [
        j.id, j.courseTitle, j.instructor, j.targetDate, j.registeredCandidates,
        j.status, j.location, j.namingSeries, j.trainerId, j.trainingStartDate,
        j.trainingEndDate, j.clientName, j.attentionLocation, j.attentionPhone,
